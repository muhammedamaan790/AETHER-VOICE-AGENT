...
**Reproduce everything:** `python -m pytest -q` → **1804 passed, 2 skipped**.
...
**1806 automated tests — 1804 passing, 2 skipped** — and both skips are deliberate, documented in the test body, and
