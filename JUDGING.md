...
**Reproduce everything:** `python -m pytest -q` → **1277 passed, 2 skipped**.
...
**1279 automated tests — 1277 passing, 2 skipped** — and both skips are deliberate, documented in the test body, and
