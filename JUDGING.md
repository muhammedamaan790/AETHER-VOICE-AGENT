...
**Reproduce everything:** `python -m pytest -q` → **1891 passed, 2 skipped**.
...
**1893 automated tests — 1891 passing, 2 skipped** — and both skips are deliberate, documented in the test body, and
