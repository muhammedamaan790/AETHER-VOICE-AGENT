...
**Reproduce everything:** `python -m pytest -q` → **1994 passed, 2 skipped**.
...
**1996 automated tests — 1994 passing, 2 skipped** — and both skips are deliberate, documented in the test body, and
