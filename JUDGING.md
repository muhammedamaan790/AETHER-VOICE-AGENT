...
**Reproduce everything:** `python -m pytest -q` → **1260 passed, 2 skipped**.
...
**1262 automated tests — 1260 passing, 2 skipped** — and both skips are deliberate, documented in the test body, and
